...
export default function Modal({ open, onClose, title, children }: Props) {
  ...
  if (!open) return null;
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-ink/55 sm:items-center">
      ...
      <div
        ...
        tabIndex={-1}
        className="modal-panel relative w-full max-w-app bg-paper p-6 max-h-[88vh] overflow-y-auto shadow-2xl pb-[max(1.5rem,env(safe-area-inset-bottom))]"
      >
        {/* 모바일 스와이프 힌트 핸들 */}
