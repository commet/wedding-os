...
const TEMPLATE: Tmpl[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "혼인신고서 작성 전 등록기준지·본·부모님 정보 확인", dday: -10, priority: "yellow" },
      { text: "혼인신고서·신분증·증인 2명 서명 확인", dday: -7 },
      { text: "한 명만 신고하러 갈 경우 상대방 신분증·도장 등 접수기관 요구사항 확인", dday: -5, priority: "yellow" },
      { text: "혼인신고 방문/우편 제출 방법 확인", dday: -3 },
      { text: "외국 국적·해외 혼인·재혼 등 해당 시 추가서류를 접수기관에 확인", dday: -3, priority: "yellow" },
      { text: "혼인신고", dday: 1 },
      { text: "혼인관계증명서·가족관계증명서 발급 후 등록 내용 확인", dday: 7 },
  ...
  },
  {
    icon: "🩺", title: "건강 · 지원",
    items: [
      { text: "임신 계획이 있다면 e보건소·관할 보건소 임신 사전건강관리 지원 대상 확인", dday: -60, priority: "yellow" },
      { text: "검사 전 검사의뢰서 발급과 참여 의료기관 예약 순서 확인", dday: -45, priority: "red" },
      { text: "검사비 청구기한·영수증·진료비 세부내역서·통장사본 보관 방법 확인", dday: -30, priority: "yellow" },
      { text: "검사 결과 상담과 후속 진료는 의료진 안내에 따라 결정", dday: -14 },
    ],
  },
];
