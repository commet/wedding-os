...
//
// ⚠️ 매우 중요한 알림:
//   - 가격(식대) 범위는 시즌·요일·메뉴에 따라 크게 달라집니다. 여기 값은 공개 정보 추정치.
...
// 공개적으로 잘 알려진 곳 위주. 가격은 공개 정보 기반 추정치 — 시즌·메뉴·요일별 변동 큼.
export const VENUE_CATALOG: WeddingVenue[] = [
  // ─── 호텔 웨딩 (서울 5성) ───
  { id: id(), name: "그랜드 인터컨티넨탈 서울 파르나스", region: "삼성동", hallType: "hotel", foodType: "course",
    capacityMin: 200, capacityMax: 600, mealPriceMin: 130000, mealPriceMax: 200000, lastVerified: today },
  { id: id(), name: "신라호텔 서울", region: "장충동", hallType: "hotel", foodType: "course",
    capacityMin: 200, capacityMax: 500, mealPriceMin: 140000, mealPriceMax: 210000, lastVerified: today },
  { id: id(), name: "롯데호텔 서울", region: "소공동", hallType: "hotel", foodType: "course",
    capacityMin: 200, capacityMax: 500, mealPriceMin: 130000, mealPriceMax: 200000, lastVerified: today },
  ...
  { id: id(), name: "콘래드 서울", region: "여의도", hallType: "hotel", foodType: "course",
    capacityMin: 150, capacityMax: 400, mealPriceMin: 120000, mealPriceMax: 180000, lastVerified: today },
  { id: id(), name: "JW 메리어트 동대문 스퀘어", region: "동대문", hallType: "hotel", foodType: "course",
    capacityMin: 150, capacityMax: 350, mealPriceMin: 120000, mealPriceMax: 180000, lastVerified: today },
  { id: id(), name: "포시즌스 호텔 서울", region: "광화문", hallType: "hotel", foodType: "course",
    capacityMin: 150, capacityMax: 350, mealPriceMin: 140000, mealPriceMax: 220000, lastVerified: today },
  { id: id(), name: "노보텔 앰배서더 강남", region: "강남", hallType: "hotel", foodType: "buffet",
    capacityMin: 200, capacityMax: 500, mealPriceMin: 90000, mealPriceMax: 150000, lastVerified: today },

  // ─── 하우스 / 채플 (단독 사용) ───
  { id: id(), name: "라움 (RAUM)", region: "청담", hallType: "house", foodType: "course",
    capacityMin: 100, capacityMax: 250, mealPriceMin: 100000, mealPriceMax: 170000, lastVerified: today },
  { id: id(), name: "더채플앳청담", region: "청담", hallType: "house", foodType: "course",
    capacityMin: 100, capacityMax: 250, mealPriceMin: 100000, mealPriceMax: 170000, lastVerified: today },
  { id: id(), name: "더베일리하우스", region: "신사동", hallType: "house", foodType: "course",
    capacityMin: 80, capacityMax: 200, mealPriceMin: 100000, mealPriceMax: 160000, lastVerified: today },
  { id: id(), name: "더사운즈한남", region: "한남동", hallType: "house", foodType: "course",
    capacityMin: 80, capacityMax: 200, mealPriceMin: 110000, mealPriceMax: 170000, lastVerified: today },
  { id: id(), name: "아펠가모 공덕", region: "공덕동", hallType: "house", foodType: "buffet",
    capacityMin: 150, capacityMax: 400, mealPriceMin: 70000, mealPriceMax: 110000, lastVerified: today },
  { id: id(), name: "정동제일교회 (채플 웨딩)", region: "정동", hallType: "house", foodType: "buffet",
    capacityMin: 100, capacityMax: 300, lastVerified: today, notes: "교회 채플 — 종교적 / 클래식한 분위기" },

  // ─── 컨벤션 / 대형 홀 ───
  { id: id(), name: "코엑스 컨벤션 & 인터컨티넨탈", region: "삼성동", hallType: "convention", foodType: "buffet",
    capacityMin: 200, capacityMax: 800, mealPriceMin: 80000, mealPriceMax: 130000, lastVerified: today },
  { id: id(), name: "킨텍스 (KINTEX)", region: "일산", hallType: "convention", foodType: "buffet",
    capacityMin: 200, capacityMax: 600, mealPriceMin: 60000, mealPriceMax: 100000, lastVerified: today },
  ...
  { id: id(), name: "SETEC", region: "삼성동", hallType: "convention", foodType: "buffet",
    capacityMin: 200, capacityMax: 500, mealPriceMin: 60000, mealPriceMax: 100000, lastVerified: today },

  // ─── 일반 결혼식장 ───
  { id: id(), name: "더채플 강남", region: "강남", hallType: "general", foodType: "buffet",
    capacityMin: 150, capacityMax: 350, mealPriceMin: 60000, mealPriceMax: 90000, lastVerified: today },
  { id: id(), name: "강남구민회관", region: "강남", hallType: "general", foodType: "buffet",
    capacityMin: 100, capacityMax: 300, mealPriceMin: 50000, mealPriceMax: 80000, lastVerified: today },
  ...
  { id: id(), name: "라마다 서울 호텔", region: "신사동", hallType: "general", foodType: "buffet",
    capacityMin: 150, capacityMax: 350, mealPriceMin: 70000, mealPriceMax: 110000, lastVerified: today },
  ...
  { id: id(), name: "워커힐 호텔 (야외 가든)", region: "광장동", hallType: "outdoor", foodType: "buffet",
    capacityMin: 100, capacityMax: 300, mealPriceMin: 100000, mealPriceMax: 160000, lastVerified: today,
    notes: "한강뷰·야외 — 5~6월 / 9~10월 추천" },
  { id: id(), name: "포레스트가든", region: "성북", hallType: "outdoor", foodType: "buffet",
    capacityMin: 80, capacityMax: 200, lastVerified: today, notes: "가든 웨딩 — 실내 백업 확인 필수" },
  { id: id(), name: "허밍그라스 (스몰 야외 웨딩)", region: "경기도", hallType: "outdoor", foodType: "buffet",
    capacityMin: 50, capacityMax: 150, lastVerified: today, notes: "스몰웨딩 · 가든" },
];

// 한국 평균 식대 정보 — 한국소비자원·웨딩 시장 공개 자료 기반
export const VENUE_PRICE_NOTE =
  "💡 한국 결혼식 식대 평균은 7~10만원대 (호텔은 13~20만원). " +
  "보증인원이 실제 하객 수보다 많으면 그 차액도 식대로 청구되니, 하객 수를 보수적으로 잡으세요.";
