    ...
    <div className="page pt-8 pb-10 max-w-app mx-auto text-[13px] leading-relaxed">
      ...
      <Section num="03" title="저장 위치">
        <ul className="list-disc list-outside pl-5 space-y-1.5 marker:text-soft">
          ...
          <li><b>간편 (운영자 호스팅·E2E)</b> · 운영자 Supabase 에 저장하되, 전체 데이터가 <b>이 기기에서 암호화된 암호문</b>으로만 올라갑니다. 복호화 키는 공유·복구 링크의 <code className="bg-cream px-1">#</code> 에만 있고 서버로 전송되지 않아, 운영자는 내용을 못 읽습니다. 보관되는 평문은 없습니다.</li>
          <li><b>독립 (내 Supabase)</b> · 본인이 가입한 Supabase 프로젝트에 직접 저장됩니다. 운영자를 거치지 않습니다.</li>
